...
const Projects: React.FC<Props> = ({ enterViewPort, exitViewPort }) => {
    ...
    return (
        <div className={currentClass} style={{ marginBottom: "80px" }}>
            ...
            <div className="card text-center" style={{ width: "14rem", backgroundColor: 'rgb(71, 71, 71)', display: 'inline-block', marginTop: '10px', marginRight: '5px' }}>
            ...
            <div className="card text-center" style={{ width: "14rem", backgroundColor: 'rgb(71, 71, 71)', display: 'inline-block', marginTop: '10px' }}>
