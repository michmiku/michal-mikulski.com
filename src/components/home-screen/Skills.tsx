...
const Skills: React.FC<Props> = ({ enterViewPort, exitViewPort }) => {
    ...
    useEffect(() => {
        if ((exitViewPort === 3 && enterViewPort === 1) || (enterViewPort === 2)) {
            setCurrentClass(true)

        }
        if (exitViewPort === 1 || (enterViewPort === 2 && exitViewPort === 4) || (enterViewPort === 3 && exitViewPort === 2) || (enterViewPort === 2 && exitViewPort === 2)) {
